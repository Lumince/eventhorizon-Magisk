...
import static com.topjohnwu.magisk.string.dling;
import static com.topjohnwu.magisk.string.no_internet_msg;
...
public class DownloadActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dynLoad = !getPackageName().equals(com.topjohnwu.magisk.BuildConfig.APPLICATION_ID);
    ...
    private void dlAPK() {
        ...
        var request = request(com.topjohnwu.magisk.BuildConfig.APK_URL).setExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
        if (dynLoad) {
